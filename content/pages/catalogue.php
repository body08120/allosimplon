...
<option value="genre1">genre1</option>
    ...
    <select class="uppercase text-[#B49FCC] tracking-[.10em] py-1 px-8 rounded-full my-3 focus:border-transparent focus:ring-0 md:my-5" name="année">
    <option>année</option>
...
<!--____________________-->
    ...
    <input class="rounded-full my-3 focus:border-transparent focus:ring-0 md:my-5 text-[#B49FCC]" type="search" placeholder="Ou tapez votre recherche..." name="search-input-catalogue" />
    <input  
        type="submit" 
        value="VALIDER" 
        name="" 
